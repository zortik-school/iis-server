...
import me.zort.iis.server.iisserver.cqrs.operation.campaign.GetCampaignStepsForCampaignOp;
...
public class GetCampaignStepsForCampaignHandler implements OperationHandler<GetCampaignStepsForCampaignOp, List<Step>> {
    ...
    public List<Step> handle(GetCampaignStepsForCampaignOp operation) {
        ...
        return campaignStepFacade.getStepsForCampaign(operation.getCampaignId());
    }

    @Override
    public Class<GetCampaignStepsForCampaignOp> getOperationType() {
        return GetCampaignStepsForCampaignOp.class;
    }
}
